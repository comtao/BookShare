...
import com.lt.book.ui.view.ViewScanResultPointCallback;
...
public final class CaptureActivityHandler extends Handler {
  ...
  private final AtyShareBook activity;
  ...
  public CaptureActivityHandler(AtyShareBook activity, Vector<BarcodeFormat> decodeFormats,
      String characterSet) {
    this.activity = activity;
    decodeThread = new DecodeThread(activity, decodeFormats, characterSet,
        new ViewScanResultPointCallback(activity.getViewScan()));
    decodeThread.start();
    state = State.SUCCESS;
